...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result && mysqli_num_rows($result) > 0) {
        ...
        // Set 'is_admin' untuk admin. Ganti logic jika pakai role di DB!
...
<body class="min-h-screen flex items-center justify-center bg-gradient-to-b from-pink-100 to-blue-100">
    <div class="w-full max-w-sm mx-auto bg-white rounded-2xl shadow-lg p-8 mt-10">
        <div class="flex flex-col items-center">
            <svg class="w-16 h-16 text-gray-400 mb-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                <circle cx="12" cy="7" r="4" />
                <path d="M5.5 19a7.5 7.5 0 0 1 13 0" />
            </svg>
            <p class="text-lg font-semibold mb-2">My Daily Journal</p>
        ...
        <form id="loginForm" method="post" autocomplete="off" class="space-y-4">
            <input 
                ...
                class="w-full py-2 px-4 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-pink-300"
